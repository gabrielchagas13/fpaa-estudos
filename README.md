...
│
└── aula 05/
    ├── 01_resumo_P_NP_coNP.md         (A Bíblia da Matéria)
    ├── 02_exercicios_felipe.md        (Os Testes)
    ├── 03_exercicios_extras_20.md     (Desafios Extras 👹)
    └── 04_simulado_prova.md           (A Prova Final)
```
...
A jornada é longa.
O caminho é escuro.
Mas quando você cruzar essa porta...
...
**Você consegue. O universo acredita em você.**
...
*"A dificuldade é apenas o sucesso em construção"* - Anônimo (e desesperado)
